...
/* USER CODE BEGIN PV */
// ADC VARIABLES
volatile uint16_t adcValues[CHANNELS];
volatile uint8_t adcFlag = 0;

// ENCODER VARIABLES
uint8_t yellowState = 0, yellowState_1 = 0;
int time = 0, timeValue = 0, timeValue_1 = 0;
...
// CONTROL VARIABLES
uint16_t reference, rpm;
float ts = 0.01, control, error, errorPrev;
float kp = 2.04;
float ki = 0.426;
//float kd = 0.0907;
